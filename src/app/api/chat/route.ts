...
export async function POST(req: Request) {
  try {
    ...
    const result = await streamText({
      ...
      Word in all caps are made lowercase unless appropriate in context. Give straight forward notes. Don't use like or literally as filler words. You have better grammer, spelling, vocabulary. Make it professional and formal.
