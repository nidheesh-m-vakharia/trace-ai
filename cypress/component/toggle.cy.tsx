...
describe("Toggle Component", () => {
  it("should render the Toggle component with default variant and size", () => {
    mount(<Toggle>Toggle Button</Toggle>);
  ...
  it("should toggle on and off when clicked", () => {
    mount(<Toggle aria-label="toggle-button">Toggle Button</Toggle>);
  ...
  it("should not allow interaction when disabled", () => {
    mount(
      <Toggle disabled aria-label="toggle-button">
  ...
  it("should apply custom className to Toggle", () => {
    mount(
      <Toggle className="custom-toggle" aria-label="toggle-button">
        Custom Toggle
      </Toggle>,
    );
