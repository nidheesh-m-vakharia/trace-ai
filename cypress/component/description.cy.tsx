...
describe('Description Component', () => {
  ...
  it('renders the paragraphs with correct content', () => {
    ...
    cy.get('[data-cy="desc-h1-1"]')
      .should('contain.text', 'Powered by OpenAI')

    // Verify the second paragraph's text
    cy.get('p').eq(1)
      .should('contain.text', 'Note-taking is a crucial skill for students and professionals alike.')
      .and('contain.text', 'With Trace AI, we aim to make note-taking more efficient by leveraging AI');
  });
